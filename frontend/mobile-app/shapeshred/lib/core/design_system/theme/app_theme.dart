  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      switchTheme: SwitchThemeData(
        ...
        thumbIcon: MaterialStateProperty.resolveWith<AppIconSize>(
          (Set<MaterialState> states) {
            if (states.contains(MaterialState.selected)) {
      ...
      alertDialogTheme: AlertDialogTheme(
        ...
        contentPadding: EdgeInsets.all(AppSpacing.contentMd),
      ),
      ...
      tooltipTheme: TooltipThemeData(
        ...
        margin: EdgeInsets.all(AppSpacing.marginSm),
        height: 36,
        verticalOffset: 24,
        preferBelow: false,
        showDuration: AppDurations.tooltipShow,
        waitDuration: AppDurations.tooltipHide,
      ),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        margin: EdgeInsets.all(AppSpacing.marginLg),
      ),
